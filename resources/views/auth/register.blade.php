            ...
            <div class="w-full lg:w-1/2">
                <div class="bg-gray-50 border rounded-lg p-8 shadow-sm">
                    ...
                    <form action="{{ route('register') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            <input type="password" placeholder="Password" id="password" name="password" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" required autocomplete="new-password"/>
                            @error('password')
                                <p class="text-sm text-red-600 mt-1 font-semibold">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            <input type="password" placeholder="Confirm Password" id="password_confirmation" name="password_confirmation" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" required autocomplete="new-password" />
